...
#Read Education file in
edu <- read.csv(file="C:\\Users\\daron\\OneDrive\\CSE 6242 - Data and Visual Analytics\\Edu Data\\education_v2.csv")

#Combine results
#crime_edu <- rbind(lm_prediction, edu)
