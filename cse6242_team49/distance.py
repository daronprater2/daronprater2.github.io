#This is the python file used to calculate the distance in miles between each pair of chicago zip codes.
#To use this file correctly follow the steps below.

#--1. Install "uszipcode" python library using pip install uszipcode
#--2. Run the following code and export the result into a csv file "distance.csv"
#--3. Use the distance.csv in the HomeWhere application
